...
public class Mes {
	...
	public void InsereNumero(){
		do{
			...
			default:System.out.println("Não foi possivel executar esta ação...");
				break;
			}
			escolha = Integer.parseInt(JOptionPane.showInputDialog("Deseja executar novamente? Digite 1 para sim e 2 para não."));
			if(escolha== 2){
